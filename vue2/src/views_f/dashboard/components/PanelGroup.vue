<template>
  <el-row :gutter="40" class="panel-group">
    <el-col v-for="(item, index) in dataSource" :key="index" :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData(item)">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="item.value" :duration="2600 + index * 200" class="card-panel-num" />
        </div>
      </div>
    </el-col>
  </el-row>
